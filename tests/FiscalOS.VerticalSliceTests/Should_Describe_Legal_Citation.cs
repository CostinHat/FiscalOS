...
public sealed class Should_Describe_Legal_Citation
{
    ...
    {
        var a = new LegalCitation(LegalSourceType.Law, "Legea 227/2015", "Art. 47");
        var b = new LegalCitation(LegalSourceType.Law, "Legea 227/2015", "Art. 47");
    ...
    {
        var original = new LegalCitation(LegalSourceType.FiscalCode, "Legea 227/2015", "Art. 47");
