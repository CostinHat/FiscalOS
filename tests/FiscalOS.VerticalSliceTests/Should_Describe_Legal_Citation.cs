...
public sealed class Should_Describe_Legal_Citation
{
    ...
    {
        var a = new LegalCitation(LegalSourceType.Law, "Legea 227/2015", "Art. 47", SpecificityLevel.General, new DateOnly(2020, 1, 1), new JurisdictionId("RO"));
        var b = new LegalCitation(LegalSourceType.Law, "Legea 227/2015", "Art. 47", SpecificityLevel.General, new DateOnly(2020, 1, 1), new JurisdictionId("RO"));
    ...
    public void Citations_that_differ_are_not_equal()
    {
        ...
        var differentJurisdiction = a with { Jurisdiction = new JurisdictionId("US") };
        ...
        Assert.NotEqual(a, differentJurisdiction);
    }

    [Fact]
    public void With_expression_does_not_mutate_the_original()
    {
        var original = new LegalCitation(LegalSourceType.FiscalCode, "Legea 227/2015", "Art. 47", SpecificityLevel.General, new DateOnly(2020, 1, 1), new JurisdictionId("RO"));
